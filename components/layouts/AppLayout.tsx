...
export const AppLayout: FC<Props> = ({ children }) => {
  return (
    <div className="min-h-screen">
      ...
      <nav className="bg-red-600 py-6 px-3 mb-6">
        <h1 className="text-3xl font-bold text-white">Calcular Población</h1>
      </nav>
      {children}

      <footer className="bg-red-600 py-6 px-8 flex justify-center text-white mt-4">
        <div className="text-center">
          <h2 className="font-medium mb-2">Huerta Murillo Alejandro Saul</h2>
